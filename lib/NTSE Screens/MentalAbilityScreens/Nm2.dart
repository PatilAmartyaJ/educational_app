...
class Nm2 extends StatefulWidget {
  @override
  _Nm2State createState() => _Nm2State();
}

class _Nm2State extends State<Nm2> {
  @override
  Widget build(BuildContext context) {
    return Container(
        child: StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance
          .collection("10Th NMentalAbility2")
          .snapshots(),
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            ChapterView(sub.id, "10Th NMentalAbility2", index2),
                      ),
                    );
                  },
                  child: Card(
